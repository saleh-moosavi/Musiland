  ...
  return (
    <div className="flex gap-x-5 items-center">
      <article className="flex items-center gap-x-3 min-w-fit group">
        ...
        <p className="absolute bottom-0 -translate-y-1/2 left-16 px-2 py-1 -translate-x-1/4 group-hover:translate-x-0 opacity-0 group-hover:opacity-100 text-xs bg-my-black-med w-fit font-semibold text-my-white-low rounded-md transition-all duration-300">
          {audioName || "Song Name"}
        </p>
      </article>
    </div>
